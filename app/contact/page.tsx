          ...
          <div className="lg:col-span-5 space-y-6">
            <div>
              ...
              <p className="text-slate-400 text-sm leading-relaxed mb-6">
                Thank you for your interest in the Standard of Excellence mentoring society. Whether you want to volunteer as a mentor, inquire about upcoming events, book signing tours, or establish a partnership, we would love to hear from you.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-slate-900/40 border border-slate-900 rounded-xl flex items-center space-x-4">
                ...
                <div>
                  <h4 className="text-xs font-semibold uppercase text-slate-500 tracking-wider">Book Signing Events</h4>
                  <p className="text-sm text-slate-400">
                    Request a tour stop or RSVP details for Pensacola, New Orleans, Charlotte, or Atlanta.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  placeholder="Describe your inquiry, volunteering interest, or RSVP details..."
                  className="w-full px-4 py-3 rounded-lg bg-slate-950 border border-slate-800 text-slate-100 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 text-sm placeholder-slate-600 transition"
                ></textarea>
              </div>
